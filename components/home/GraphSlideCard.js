...
/*
// get current capacity rom fitx api
...
const GraphSlideCard = (itemData) => {
    ...
    useEffect(() => {
        ...
        /*if (today.getDay() === itemData.itemData.weekday) {
            ...
            todayValuesTemp[todayValuesTemp.length-1].value = currentCapacity;
        }*/
                              ...
                              style={{       
                                ...
                                {pointerIndex < todayValues.length ? (
                                    ...
                                    pointerIndex === todayValues.length - 1 ?  (
                                        <Text style={styles.pointerLabelActive}>{today.getHours() + ':' + today.getMinutes()} <Text style={{color: 'white', fontFamily: FONT.medium, fontSize:12}}>{todayValues.slice(-1).value + '%'}</Text></Text> 
